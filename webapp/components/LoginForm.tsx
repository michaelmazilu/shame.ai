...
type Step = "initial" | "credentials" | "2fa" | "checkpoint";
...
export default function LoginForm() {
  ...
  async function handleBrowserLogin() {
    ...
    try {
      const resp = await fetch("/api/auth/browser", { method: "POST" });
  ...
  // Default: try Playwright browser login first
  return (
