...
const ratingData = [
  { emoji: "💀", label: "Dead inside", color: "from-red-400 to-red-500", shadowColor: "shadow-red-500/30" },
  { emoji: "🤮", label: "Disgusting", color: "from-orange-400 to-orange-500", shadowColor: "shadow-orange-500/30" },
  { emoji: "😭", label: "Traumatized", color: "from-yellow-400 to-yellow-500", shadowColor: "shadow-yellow-500/30" },
  { emoji: "🤬", label: "Furious", color: "from-rose-400 to-rose-500", shadowColor: "shadow-rose-500/30" },
  { emoji: "😡", label: "Worst ever", color: "from-red-500 to-red-600", shadowColor: "shadow-red-600/30" },
]
